...
# create 'turnstile' table using the 'turnstile' topic, then create 'turnstile_summary' table using the 'turnstile' table. output topic must be 'TURNSTILE_SUMMARY'
KSQL_STATEMENT = """
CREATE TABLE turnstile (
    ...
    KAFKA_TOPIC='org.chicago.cta.station.turnstile_events',
    VALUE_FORMAT='AVRO',
    KEY='station_id'
);
